...
def main(args,config):
    ...
    args.data_path_test = config['data_path_test']
    ...
    for train_idxs, test_idxs in group_kfold.split(df_data['audio_feature_scaled'], df_data['label'], groups):
        ...
        print("start here")
        print(args.data_updated.shape, args.data_updated_test.shape)
        print('\n\n\n\n\n')
        # (re)set up model
...
if __name__ == '__main__': 
    ...
    parser.add_argument("--gamma", type=float, default=.95, help="gamma for optimizer")
    ...
    # data_path is for training and data_path_test is for test, could be the same data source
    # used for cross test abaliation study

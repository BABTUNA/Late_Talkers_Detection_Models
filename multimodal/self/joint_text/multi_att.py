...
class FusionModel(LightningModule):
    ...
    def forward(self, joint_input_ids, audio_input_ids, mask=None, **kwargs):
        ...
        joint_embed, _ = self.mha_t(joint_embed, joint_embed, joint_embed)
        ...
        audio_embed, _ = self.mha_a(audio_embed, audio_embed, audio_embed) 
    ...
    def test_epoch_end(self, outputs):
        ...
        pred_df.to_csv(
            f'att_{self.args.random_seed}_{self.args.heads}_{self.args.epochs}_{self.args.hidden_size}_{self.args.batch_size}_test_pred.csv', index=False)
        ...
        df_result.to_csv(
            f'att_{self.args.random_seed}_{self.args.heads}_{self.args.epochs}_{self.args.hidden_size}_{self.args.batch_size}_test.csv')
...
if __name__ == '__main__': 
    ...
    parser.add_argument("--joint_feats", type=int, default=300)
    parser.add_argument("--audio_feats", type=int, default=30)

    parser.add_argument("--heads", type=int, default=16)
    parser.add_argument("--joint_nh", type=int, default=16)
    parser.add_argument("--audio_nh", type=int, default=16)

...
class FusionModel(LightningModule):
    ...
    def preprocess_dataframe(self):
        ...
        #print(df[t_col_name])
        encoded_data = df[t_col_name].apply(lambda x: self.text_model.t_tokenizer.encode_plus(
            str(x),
            padding = 'max_length',
        ...
        df[t_col_name] = encoded_data.apply(lambda x: x['input_ids'].squeeze(0).tolist())
        df['attention_mask'] = encoded_data.apply(lambda x: x['attention_mask'].squeeze(0).tolist())
        #print(df[t_col_name])
...
if __name__ == '__main__': 
    ...
    # datasets 
    parser.add_argument("--data_path", type=str, default="/home/benjaminbarrera-altuna/Desktop/LLE/dataset/data_50_full.json")
